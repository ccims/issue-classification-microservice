...
class ParallelBackendBase(metaclass=ABCMeta):
    ...
    def configure(self, n_jobs=..., parallel=..., prefer=..., require=..., **backend_args):
...
class MultiprocessingBackend(PoolManagerMixin, AutoBatchingMixin, ParallelBackendBase):
    ...
    def configure(self, n_jobs=..., parallel=..., prefer=..., require=..., **memmappingpool_args):
        """Build a process or thread pool and return the number of workers"""
        ...
...
class LokyBackend(AutoBatchingMixin, ParallelBackendBase):
    ...
    supports_timeout = ...
    supports_inner_max_num_threads = ...
    def configure(self, n_jobs=..., parallel=..., prefer=..., require=..., idle_worker_timeout=..., **memmappingexecutor_args):
