...
SYSTEM_SHARED_MEM_FS_MIN_SIZE = int(2000000000)
...
def get_memmapping_reducers(forward_reducers=..., backward_reducers=..., temp_folder_resolver=..., max_nbytes=..., mmap_mode=..., verbose=..., prewarm=..., unlink_on_gc_collect=..., **kwargs):
