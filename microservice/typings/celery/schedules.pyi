...
class crontab(BaseSchedule):
    ...
    """
    def __init__(self, minute=..., hour=..., day_of_week=..., day_of_month=..., month_of_year=..., **kwargs) -> None:
        ...
    ...
    def remaining_estimate(self, last_run_at, ffwd=...):
...
def maybe_schedule(s, relative=..., app=...):
