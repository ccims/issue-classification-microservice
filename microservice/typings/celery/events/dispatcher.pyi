...
class EventDispatcher:
    ...
    on_enabled = ...
    on_disabled = ...
    def __init__(self, connection=..., hostname=..., enabled=..., channel=..., buffer_while_offline=..., app=..., serializer=..., groups=..., delivery_mode=..., buffer_group=..., buffer_limit=..., on_send_buffered=...) -> None:
        ...
    ...
    def publish(self, type, fields, producer, blind=..., Event=..., **kwargs):
    ...
    def send(self, type, blind=..., utcoffset=..., retry=..., retry_policy=..., Event=..., **fields):
        """Send event.
