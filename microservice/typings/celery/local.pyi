...
COMPAT_MODULES = { 'celery': { 'execute': { 'send_task': 'send_task' },'decorators': { 'task': 'task','periodic_task': _compat_periodic_task_decorator },'log': { 'get_default_logger': 'log.get_default_logger','setup_logger': 'log.setup_logger','setup_logging_subsystem': 'log.setup_logging_subsystem','redirect_stdouts_to_logger': 'log.redirect_stdouts_to_logger' },'messaging': { 'TaskConsumer': 'amqp.TaskConsumer','establish_connection': 'connection','get_consumer_set': 'amqp.TaskConsumer' },'registry': { 'tasks': 'tasks' } },'celery.task': { 'control': { 'broadcast': 'control.broadcast','rate_limit': 'control.rate_limit','time_limit': 'control.time_limit','ping': 'control.ping','revoke': 'control.revoke','discard_all': 'control.purge','inspect': 'control.inspect' },'schedules': 'celery.schedules','chords': 'celery.canvas' } }
...
def recreate_module(name, compat_modules=..., by_module=..., direct=..., base=..., **attrs):
    ...
