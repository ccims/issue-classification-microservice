...
class Task:
    ...
    def apply_async(self, args=..., kwargs=..., task_id=..., producer=..., link=..., link_error=..., shadow=..., **options):
    ...
    def signature_from_request(self, request=..., args=..., kwargs=..., queue=..., **extra_options):
        ...
    
    subtask_from_request = ...
    def retry(self, args=..., kwargs=..., exc=..., throw=..., eta=..., countdown=..., max_retries=..., **options):
    ...
    def apply(self, args=..., kwargs=..., link=..., link_error=..., task_id=..., retries=..., throw=..., logfile=..., loglevel=..., headers=..., **options):
    ...
    def signature(self, args=..., *starargs, **starkwargs):
        """Create signature.
