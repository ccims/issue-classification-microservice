...
class Celery:
    ...
    on_after_finalize = ...
    on_after_fork = ...
    def __init__(self, main=..., loader=..., backend=..., amqp=..., events=..., log=..., control=..., set_as_current=..., tasks=..., broker=..., include=..., changes=..., config_source=..., fixups=..., task_cls=..., autofinalize=..., namespace=..., strict_typing=..., **kwargs) -> None:
        ...
    ...
    def config_from_object(self, obj, silent=..., force=..., namespace=...):
    ...
    def config_from_envvar(self, variable_name, silent=..., force=...):
    ...
    def setup_security(self, allowed_serializers=..., key=..., cert=..., store=..., digest=..., serializer=...):
    ...
    def autodiscover_tasks(self, packages=..., related_name=..., force=...):
    ...
    def send_task(self, name, args=..., kwargs=..., countdown=..., eta=..., task_id=..., producer=..., connection=..., router=..., result_cls=..., expires=..., publisher=..., link=..., link_error=..., add_to_parent=..., group_id=..., group_index=..., retries=..., chord=..., reply_to=..., time_limit=..., soft_time_limit=..., root_id=..., parent_id=..., route_name=..., shadow=..., chain=..., task_type=..., **options):
        """Send task by name.
    ...
    def connection(self, hostname=..., userid=..., password=..., virtual_host=..., port=..., ssl=..., connect_timeout=..., transport=..., transport_options=..., heartbeat=..., login_method=..., failover_strategy=..., **kwargs):
    ...
    broker_connection = ...
    def connection_or_acquire(self, connection=..., pool=..., *_, **__):
    ...
    def add_periodic_task(self, schedule, sig, args=..., kwargs=..., name=..., **opts):
        ...
    ...
    def subclass_with_self(self, Class, name=..., attribute=..., reverse=..., keep_reduce=..., **kw):
