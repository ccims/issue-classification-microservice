...
class JsonIOStream(object):
    ...
    @classmethod
    def from_process(cls, process, name=...):
    ...
    def write_json(self, value, encoder=...):
...
class MessageDict(collections.OrderedDict):
    ...
    def __call__(self, key, validate, optional=...):
...
class OutgoingRequest(Request):
    ...
    def wait_for_response(self, raise_if_failed=...):
...
class JsonMessageChannel(object):
    ...
    _prettify_order = ...
    def send_request(self, command, arguments=..., on_before_send=...):
